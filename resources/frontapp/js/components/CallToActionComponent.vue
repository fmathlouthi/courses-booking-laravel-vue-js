<template>
  <div class="flex justify-center items-center w-screen bg-red-400">
  <!-- COMPONENT CODE -->
            ...
            <div class="py-2 mx-4 lg:py-10">
              <div class="rounded-full bg-white shadow  flex w-full">
                <input
                  ...
                  class="w-full rounded-tl-full rounded-bl-full px-4 py-5" />
                <button class="bg-yellow-400 rounded-tr-full rounded-br-full hover:bg-red-300 px-4 py-5">
