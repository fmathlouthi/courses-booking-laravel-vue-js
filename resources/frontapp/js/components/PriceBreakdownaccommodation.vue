...
<div >
 <div class="bg-pay p-3"> 
                <div class="d-flex justify-content-between mt-2"> <span class="fw-500">Start Date : </span> <span>{{ price.startDate.starting_date }}</span> </div>
                <hr>
                <div class="d-flex justify-content-between mt-2"> <span class="fw-500">End Date : </span> <span>{{ price.fromdate }}</span> </div>
                <hr>
                <div class="d-flex justify-content-between mt-2"> <span class="lh-16 fw-500">Weeks number  : </span> <span>{{ price.weeksnumber }}</span> </div>
