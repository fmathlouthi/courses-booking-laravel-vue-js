<template>
    <div class="w-48 bg-white rounded-lg shadow-md p-6 hover:cursor-pointer mb-8 hover:bg-green-lightest focus:outline-none focus:shadow-outline-green" :class="{'bg-green-lightest shadow-outline-green' : this.activePlanacom === this.planName}" tabindex="0" @click="updateActivePlan" @keydown.space="updateActivePlan">
      <div class="flex justify-between items-center mb-3">
        <h1 class="uppercase text-base tracking-wide text-blue-darker my-2">{{ this.planName }}</h1>
        <div v-if="this.activePlanacom === this.planName">
      ...
      <div class="mb-1 font-semibold text-blue-darker">
        <span class="text-5xl mr-2"><i class="fa fa-eye" aria-hidden="true"></i></span>
      </div>

      <div>
        <span class="text-xl text-blue-alternate">$</span>
        <span class="text-xl font-semibold text-blue-darker">{{ this.planPrice }}</span>
        <span class="text-blue-alternate mx-1">/</span>
        <span class="text-lg text-blue-alternate">WEEK</span>
      </div>
    </div>
</template>
...
export default {
  ...
  props: ['planName', 'planDescription', 'planPrice', 'activePlanacom'],
  methods: {
    updateActivePlan() {
...
.hover\:border-blue-alternate:hover {
	border-color: #366a8f
}
...
.focus\:border-blue-alternate:focus {
	border-color: #366a8f
}
...
.hover\:text-blue-alternate:hover {
	color: #366a8f
}
...
.focus\:text-blue-alternate:focus {
	color: #366a8f
}
...
@media (min-width:576px) {
	...
	.sm\:hover\:bg-blue-alternate:hover {
		background-color: #366a8f
	}
	...
	.sm\:focus\:bg-blue-alternate:focus {
		background-color: #366a8f
	}
	...
	.sm\:hover\:border-blue-alternate:hover {
		border-color: #366a8f
	}
	...
	.sm\:focus\:border-blue-alternate:focus {
		border-color: #366a8f
	}
	...
	.sm\:hover\:text-blue-alternate:hover {
		color: #366a8f
	}
	...
	.sm\:focus\:text-blue-alternate:focus {
		color: #366a8f
	}
...
@media (min-width:768px) {
	...
	.md\:hover\:bg-blue-alternate:hover {
		background-color: #366a8f
	}
	...
	.md\:focus\:bg-blue-alternate:focus {
		background-color: #366a8f
	}
	...
	.md\:hover\:border-blue-alternate:hover {
		border-color: #366a8f
	}
	...
	.md\:focus\:border-blue-alternate:focus {
		border-color: #366a8f
	}
	...
	.md\:hover\:text-blue-alternate:hover {
		color: #366a8f
	}
	...
	.md\:focus\:text-blue-alternate:focus {
		color: #366a8f
	}
...
@media (min-width:992px) {
	...
	.lg\:hover\:bg-blue-alternate:hover {
		background-color: #366a8f
	}
	...
	.lg\:focus\:bg-blue-alternate:focus {
		background-color: #366a8f
	}
	...
	.lg\:hover\:border-blue-alternate:hover {
		border-color: #366a8f
	}
	...
	.lg\:focus\:border-blue-alternate:focus {
		border-color: #366a8f
	}
	...
	.lg\:hover\:text-blue-alternate:hover {
		color: #366a8f
	}
	...
	.lg\:focus\:text-blue-alternate:focus {
		color: #366a8f
	}
...
@media (min-width:1200px) {
	...
	.xl\:hover\:bg-blue-alternate:hover {
		background-color: #366a8f
	}
	...
	.xl\:focus\:bg-blue-alternate:focus {
		background-color: #366a8f
	}
	...
	.xl\:hover\:border-blue-alternate:hover {
		border-color: #366a8f
	}
	...
	.xl\:focus\:border-blue-alternate:focus {
		border-color: #366a8f
	}
	...
	.xl\:hover\:text-blue-alternate:hover {
		color: #366a8f
	}
	...
	.xl\:focus\:text-blue-alternate:focus {
		color: #366a8f
	}
