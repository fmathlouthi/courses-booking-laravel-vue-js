          ...
          <section id="left_column" class="column sidebar col-md-3">
            <div>
              <div id="categories_block_left" class="block">
                <h4 class="title_block">SEARCH Programs</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="product-image-container image">
                          ...
                          >
                            <img
                              ...
                              :src="product.university.featured_image[0].url"
                              alt="ACCORD Paris"
                              title="ACCORD Paris"
                              width="370"
                              height="235"
                      ...
                      <div class="right-block col-md-8 col-sm-8">
                        <div class="col1">
                          <div class="product-meta">
                            ...
                            <h5 itemprop="name" class="name">
                              <a
                                ...
                                itemprop="url"
                              >
                                {{product.name}} ({{ product.university.city.name }})
                              </a>
                            </h5>
                            <h6 class="name">({{ product.university.name }})</h6>
                          ...
                          <div class="featsize">
                            <div
                              v-for="feature in product.university.features"
                              :key="feature.id"
                            >
                              <div class="col-sm-2">
                                <div class="tooltip2">
                        ...
                        <div class="col2">
                          <div class="box-buttons">
                            ...
                            <div class="view">
                              <router-link
                          :to="{ path: '/singlesubjectprogram/' + product.id }"
