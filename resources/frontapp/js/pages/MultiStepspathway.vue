<template>
  <div>
   ...
   <!--Grid column-->
                  <div class="col-md-6">
                    <div class="md-form mb-0">
                      <label for="email">Progression University degree *</label>
                      <model-select
                        :options="pathwaylist"
...
export default {
  ...
  methods: {
    getSubjects: function () {
      axios.get(`/subjectlistpathway`).then(
        function (response) {
    ...
    async onComplete() {
      ...
      this.errors = null;
      try {
        await axios.post(`newrequestpathway`, {
          data: this.formData,
