          ...
          <div class="card">
            <div class="card-header card-header-primary card-header-icon">
              ...
              <h4 class="card-title">
                {{ $t('global.create') }}
                <strong>{{
                  $t('cruds.universityRequest.title_singular')
                }}</strong>
              </h4>
            </div>
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>{{
                      $t('cruds.universityRequest.fields.student_first_name')
                    }}</label>
                    <div
                  ...
                  <div class="form-group">
                    <label>{{
                      $t('cruds.universityRequest.fields.student_last_name')
                    }}</label>
                    <div
                      class="form-group bmd-form-group"
                      :class="{
                  ...
                  <div class="form-group">
                    <label>{{
                      $t('cruds.universityRequest.fields.gendre')
                    }}</label>
                    <v-radio
                      :value="entry.gendre"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.nationality')
                    }}</label>
                    <v-select
                      name="nationality"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.level_of_study')
                    }}</label>
                    <v-select
                      name="level_of_study"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.universityRequest.fields.email')
                    }}</label>
                    <input
                      class="form-control"
                      type="email"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.phone')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.universityRequest.fields.country')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.universityRequest.fields.post_code')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.state')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.city')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.address_1')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.address_2')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.special_needs')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.comments,
                      'is-focused': activeField == 'comments'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.comments')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.universityRequest.fields.preferred_intake')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.university_degree,
                      'is-focused': activeField == 'university_degree'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.university_degree')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                      :value="entry.university_degree"
                      @input="updateUniversityDegree"
                      @focus="focusField('university_degree')"
                      @blur="clearFocus"
                    />
                  </div>
                  <div
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.university_college')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.secondary_school')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.english_proficiency')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.current_address')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.date_of_birth')
                    }}</label>
                    <datetime-picker
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.subject')
                    }}</label>
                    <v-select
                      name="subject"
                      label="name"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.universityRequest.fields.university')
                    }}</label>
                    <v-select
                      name="university"
                      label="name"
...
export default {
  ...
  computed: {
    ...mapGetters('UniversityRequestsSingle', ['entry', 'loading', 'lists'])
  },
  mounted() {
  ...
  methods: {
    ...mapActions('UniversityRequestsSingle', [
      'storeData',
      'resetState',
      'setStudentFirstName',
      'setStudentLastName',
    ...
    submitForm() {
      this.storeData()
        .then(() => {
          this.$router.push({ name: 'university_requests.index' })
