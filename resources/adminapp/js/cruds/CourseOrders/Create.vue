              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.coupon_id !== null,
                      'is-focused': activeField == 'coupon'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.courseOrder.fields.coupon')
                    }}</label>
                    <v-select
                      name="coupon"
                      label="name"
                      ...
                      :options="lists.coupon"
                      :reduce="entry => entry.id"
                      @input="updateCoupon"
                      @search.focus="focusField('coupon')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.courseOrder.fields.course')
                    }}</label>
                    <v-select
                      name="course"
                      label="name"
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.extra_id !== null,
                      'is-focused': activeField == 'extra'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.courseOrder.fields.extra')
                    }}</label>
                    <v-select
                      name="extra"
                      label="name"
                      :key="'extra-field'"
                      :value="entry.extra_id"
                      :options="lists.extra"
                      :reduce="entry => entry.id"
                      @input="updateExtra"
...
export default {
  ...
  computed: {
    ...mapGetters('CourseOrdersSingle', ['entry', 'loading', 'lists'])
  },
  mounted() {
  ...
  methods: {
    ...
    submitForm() {
      this.storeData()
        .then(() => {
          this.$router.push({ name: 'course_orders.index' })
