                  ...
                  <div class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-single :row="entry" field="coupon.name">
                          </datatable-single>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-enum :row="entry" field="payment_status">
                          </datatable-enum>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-single :row="entry" field="course.name">
                          </datatable-single>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <datatable-single :row="entry" field="extra.name">
                          </datatable-single>
                        </td>
                      </tr>
                      <tr>
...
export default {
  ...
  computed: {
    ...mapGetters('CourseOrdersSingle', ['entry'])
  },
  watch: {
    '$route.params.id': {
      immediate: true,
  ...
  methods: {
    ...mapActions('CourseOrdersSingle', ['fetchShowData', 'resetState'])
  }
}
</script>
