                    ...
                    <tbody>
                      <tr>
                        <td class="text-primary">
                          {{ $t('cruds.subjectProgram.fields.id') }}
                        </td>
                        <td>
                          {{ entry.id }}
                        </td>
...
export default {
  ...
  computed: {
    ...mapGetters('SubjectProgramsSingle', ['entry'])
  },
  watch: {
    '$route.params.id': {
      immediate: true,
  ...
  methods: {
    ...mapActions('SubjectProgramsSingle', ['fetchShowData', 'resetState'])
  }
}
</script>
