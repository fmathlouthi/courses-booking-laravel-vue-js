        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary card-header-icon">
              ...
              <h4 class="card-title">
                {{ $t('global.create') }}
                <strong>{{ $t('cruds.weeklyCourse.title_singular') }}</strong>
              </h4>
            </div>
            <div class="card-body">
                ...
                <div class="col-md-12">
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.weeklyCourse.fields.name')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  <div class="form-group">
                    <label>{{
                      $t('cruds.weeklyCourse.fields.description')
                    }}</label>
                    <ckeditor
                      :editor="editor"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.weeklyCourse.fields.price')
                    }}</label>
                    <input
                      class="form-control"
                      type="number"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.weeklyCourse.fields.university')
                    }}</label>
                    <v-select
                      name="university"
                      label="name"
...
export default {
  ...
  computed: {
    ...mapGetters('WeeklyCoursesSingle', ['entry', 'loading', 'lists'])
  },
  mounted() {
  ...
  methods: {
    ...mapActions('WeeklyCoursesSingle', [
      'storeData',
      'resetState',
      'setName',
      'setDescription',
    ...
    submitForm() {
      this.storeData()
        .then(() => {
          this.$router.push({ name: 'weekly_courses.index' })
