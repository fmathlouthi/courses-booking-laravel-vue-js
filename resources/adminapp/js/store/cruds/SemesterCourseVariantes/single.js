...
const route = 'semester-course-variantes'
...
const actions = {
    ...
    setSemesterCourse({ commit }, value) {
        commit('setSemesterCourse', value)
    },
...
const mutations = {
    ...
    setSemesterCourse(state, value) {
        state.entry.semester_course_id = value
    },
