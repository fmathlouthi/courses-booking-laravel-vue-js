          ...
          children: [
            {
              ...
              icon: 'table_view',
              path: { name: 'coupons.index' },
              gate: 'coupon_access'
            },
            {
              title: 'cruds.language.title',
              icon: 'table_view',
              path: { name: 'languages.index' },
          ...
          children: [
            {
              ...
              icon: 'table_view',
              path: { name: 'university_subjects.index' },
